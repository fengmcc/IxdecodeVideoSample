...
class CudaBuffer final : public Token {
public:
  CudaBuffer() = delete;
...
struct   SurfacePlane {
  ...
  /* Returns true ifclass owns the memory, false otherwise;
   */
 ...
 * Pure interfaceclass , see ancestors;
 */
class Surface : public Token {
public:
  virtual ~Surface();
 ...
 */
class SurfaceY final : public Surface {
public:
  ~SurfaceY();
...
/* 8-bit NV12 image;
 */
class SurfaceNV12 : public Surface {
public:
  ~SurfaceNV12();
...
/* 8-bit YUV420P image;
 */
class SurfaceYUV420 : public Surface {
public:
  ~SurfaceYUV420();
 ...
 */
class SurfaceNV12Planar : public Surface
{
public:
  ~SurfaceNV12Planar();
...
class SurfaceP10 : public SurfaceNV12 {
public:
...
/* 8-bit NV12 image;
 */
class SurfaceP12 : public Surface
{
public:
  ~SurfaceP12();
...
class SurfaceYUV422 : public Surface {
public:
  ~SurfaceYUV422();
...
class SurfaceYCbCr final : public SurfaceYUV420 {
public:
...
/* 8-bit BGR image;
 */
class SurfaceBGR : public SurfaceRGB {
public:
  ~SurfaceBGR();
 ...
 */
class SurfaceRGBPlanar : public Surface {
public:
  ~SurfaceRGBPlanar();
...
class SurfaceYUV444 : public SurfaceRGBPlanar {
public:
 ...
 */
class SurfaceRGB32F : public Surface {
public:
  ~SurfaceRGB32F();
 ...
 */
class SurfaceRGB32FPlanar : public Surface {
public:
  ~SurfaceRGB32FPlanar();
...
class SurfaceYUV444_10bit : public SurfaceRGBPlanar
{
public:
  Pixel_Format PixelFormat() const override { return YUV444; }
